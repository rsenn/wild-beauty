...
(function() {
  ...
  if(ENVIRONMENT_IS_NODE) {
    ...
    if(typeof WebAssembly === "undefined") {
      var fs = require("fs");
      eval(fs.readFileSync(locateFile("bpgdec.wasm.js")) + "");
    }
    ...
    if(typeof WebAssembly === "undefined") {
      eval(read(locateFile("bpgdec.wasm.js")) + "");
    }
  ...
  var wasmMemory;
  var wasmTable = new WebAssembly.Table({ initial: 38, maximum: 38 + 0, element: "anyfunc" });
  var ABORT = false;
  var EXITSTATUS = 0;
  ...
  var asmLibraryArg = { abort: _abort, emscripten_get_sbrk_ptr: _emscripten_get_sbrk_ptr, emscripten_memcpy_big: _emscripten_memcpy_big, emscripten_resize_heap: _emscripten_resize_heap, getTempRet0: getTempRet0, memory: wasmMemory, setTempRet0: setTempRet0, table: wasmTable };
  var asm = createWasm();
  Module["asm"] = asm;
  ...
  var _bpg_decoder_get_info = (Module["_bpg_decoder_get_info"] = function() {
    return (_bpg_decoder_get_info = Module["_bpg_decoder_get_info"] = Module["asm"]["bpg_decoder_get_info"]).apply(null, arguments);
  });
  var _bpg_decoder_start = (Module["_bpg_decoder_start"] = function() {
    return (_bpg_decoder_start = Module["_bpg_decoder_start"] = Module["asm"]["bpg_decoder_start"]).apply(null, arguments);
  });
  var _bpg_decoder_get_frame_duration = (Module["_bpg_decoder_get_frame_duration"] = function() {
    return (_bpg_decoder_get_frame_duration = Module["_bpg_decoder_get_frame_duration"] = Module["asm"]["bpg_decoder_get_frame_duration"]).apply(null, arguments);
  });
  var _bpg_decoder_get_line = (Module["_bpg_decoder_get_line"] = function() {
    return (_bpg_decoder_get_line = Module["_bpg_decoder_get_line"] = Module["asm"]["bpg_decoder_get_line"]).apply(null, arguments);
  });
  var _bpg_decoder_open = (Module["_bpg_decoder_open"] = function() {
    return (_bpg_decoder_open = Module["_bpg_decoder_open"] = Module["asm"]["bpg_decoder_open"]).apply(null, arguments);
  });
  var _bpg_decoder_decode = (Module["_bpg_decoder_decode"] = function() {
    return (_bpg_decoder_decode = Module["_bpg_decoder_decode"] = Module["asm"]["bpg_decoder_decode"]).apply(null, arguments);
  });
  var _bpg_decoder_close = (Module["_bpg_decoder_close"] = function() {
    return (_bpg_decoder_close = Module["_bpg_decoder_close"] = Module["asm"]["bpg_decoder_close"]).apply(null, arguments);
  });
