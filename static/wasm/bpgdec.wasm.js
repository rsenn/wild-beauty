...
(function() {
  ...
  function createWasm() {
    ...
    function receiveInstance(instance, module) {
      ...
      Module["asm"] = exports;
            window.bpgdec=instance;

      removeRunDependency("wasm-instantiate");
    }
    addRunDependency("wasm-instantiate");
    function receiveInstantiatedSource(output) {
      console.log("receiveInstantiatedSource", output);
  ...
  var asmLibraryArg = { abort: _abort, emscripten_get_sbrk_ptr: _emscripten_get_sbrk_ptr, emscripten_memcpy_big: _emscripten_memcpy_big, emscripten_resize_heap: _emscripten_resize_heap, memory: wasmMemory, table: wasmTable };
  var asm = createWasm();
  Module["asm"] = asm;
