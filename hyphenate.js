...
const Hyphenator = function(patterns, exceptions) {
  ...
  this.hyphenate_word = function(word) {
    ...
    const pieces = [""];
    const pts = points.slice(2, points.length - 1);
