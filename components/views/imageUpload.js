                  ...
                  <svg height="24" width="24" viewBox="0 0 16 16">
                    ...
                    <g transform={`translate(7.483179807662964, 0)`}>
                      <g transform={` scale(${shift ? -1 : 1}, 1)`}>
                        <g transform={`translate(-7.483179807662964, 0)`}>
                          <path d="M11.993 10.754 a 5.059 5.059 0 01-3.176 2.27 5.056 5.056 0 01-3.84-.708 A 5.051 5.051 0 012.872 9.31 a 5.051 5.051 0 01.517-3.634 h 0 A 4.969 4.969 0 016.328 3.09 a 4.97 4.97 0 013.895.39 4.94 4.94 0 012.005 2.11" fill="none" stroke="#00f" strokeWidth="1.66983039" />
