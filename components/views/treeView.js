...
*/
  ...
  const items = [...Table2DIterator(table)].map((item, i) => {
    ...
    //  console.log(`TreeView.render `, data);
  ...
  /*  let obj = {
    ...
    children: [
      { tagName: "defs" },
      {
        tagName: "g",
        id: "tree",
        transform: `translate(${offs_x * scale_x}, ${offs_y * scale_y})`,
        children: []
      }
    ]
  };
*/
  //return ReactComponent.create(obj);
