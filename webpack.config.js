...
function preamble(name) {
  return ["/**", " * @license", " * " + name, " * Copyright Daniel Wirtz / The AssemblyScript Authors.", " * SPDX-License-Identifier: Apache-2.0", " */"].join("\n");
}
...
const bin = {
  ...
  entry: ["./asc.js"],
  externals: [{ "../dist/assemblyscript.js": "assemblyscript" }],
  node: {
    buffer: false,
    fs: "empty",
    global: true,
