...
exports.default = exports.observe = void 0
...
function calculateChangedBits(prevValue, nextValue) {
  ...
  if (prevValue.scrollY !== nextValue.scrollY) {
    observedBits =
      prevValue.scrollX !== nextValue.scrollX ? observe.scroll : observe.scrollY
...
var _default = _react.default.createContext({}, calculateChangedBits)
